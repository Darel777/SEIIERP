      ...
      <template #header>
        <el-row>
          <el-col :span="18">
            ...
            <el-button class="z" type="primary" size="medium" @click="approval2(item)">赠送</el-button>
...
import {sale_strategy} from "@/network/purchase";
export default {
  name: 'SaleList',
  props: {
    list: Array,
  ...
  methods: {
    ...
    //
    //   console.log(item)
    //   let saleSheetVO=item
    //     secondApproval(config)
    //     sale_strategy(saleSheetVO)
    //     console.log("in")
    //     // window.location.reload()
    //   },
