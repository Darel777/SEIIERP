...
export default {
  ...
  methods: {
    getExcel(){
      ...
      let str='单号,销售商ID,业务员,操作员,备注,折让前总额,审批状态,折让后总额,折扣,代金券\n'
    ...
    isLegal(item){
      if(this.area.start_year === ''){
        ...
        // console.log(start_year,start_month,start_date,current_year,current_month,current_date,end_year,end_month,end_date)
