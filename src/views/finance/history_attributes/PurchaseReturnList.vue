        ...
        <el-row >
          <el-col :span="18">
            ...
            <span style="margin-left: 10px">
              ...
              <el-tag v-if="type === 4 && (authorization() ===1 || authorization() === 2)" effect="dark" type='danger'>审核未通过</el-tag>
            </span>
          </el-col>
          <el-col :span="6">
...
export default {
  ...
  methods: {
    getExcel(){
      ...
      let str='单号,对应进货单号,操作员,备注,总额,审批状态,时间\n'
      for(let i=0;i<this.res.length;i++){
        for(const key in this.res[i]){
          if(key.toString() !== 'purchaseReturnsSheetContent')
            str+=`${this.res[i][key] + '\t'},`;
        }
        str+='\n'
      }
